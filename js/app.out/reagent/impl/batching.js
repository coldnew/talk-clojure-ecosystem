...
var or__6484__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__6484__auto__)){
return or__6484__auto__;
} else {
var or__6484__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__6484__auto____$1)){
return or__6484__auto____$1;
} else {
var or__6484__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__6484__auto____$2)){
return or__6484__auto____$2;
} else {
var or__6484__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__6484__auto____$3)){
return or__6484__auto____$3;
} else {
...
var n__7387__auto__ = a.length;
var i = (0);
while(true){
if((i < n__7387__auto__)){
var c_12922 = (a[i]);
if((c_12922["cljsIsDirty"]) === true){
(c_12922["forceUpdate"])();
} else {
}
...
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(cljs.core.cst$sym$some_QMARK_,cljs.core.cst$sym$f)], 0)))].join('')));
}
...
var G__12924 = ((function (this$){
return (function (){
return this$.run_queues();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__12924) : reagent.impl.batching.next_tick.call(null,G__12924));
}
});
...
var temp__4661__auto___12926 = (this$["componentQueue"]);
if((temp__4661__auto___12926 == null)){
} else {
var cs_12927 = temp__4661__auto___12926;
(this$["componentQueue"] = null);

reagent.impl.batching.run_queue(cs_12927);
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__7082__auto__,writer__7083__auto__,opt__7084__auto__){
return cljs.core._write(writer__7083__auto__,"reagent.impl.batching/RenderQueue");
});
