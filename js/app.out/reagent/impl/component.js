...
if((i < len)){
var k = (ks[i]);
var G__13123 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__13124 = (i + (1));
m = G__13123;
i = G__13124;
continue;
...
return (G__13128__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__13132 = c;
var G__13132__$1 = (((G__13132 == null))?null:G__13132.prototype);
if((G__13132__$1 == null)){
return null;
} else {
return (G__13132__$1["render"]);
}
})()));
});
...
var _STAR_current_component_STAR_13141 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_13141;
}});
...
var G__13149 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__13149) {
...
return ((function (G__13149){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__13152 = reagent.impl.component.state_atom(c);
var G__13153 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__13152,G__13153) : cljs.core.reset_BANG_.call(null,G__13152,G__13153));
});
;})(G__13149))
...
var c = this;
var G__13155_13157 = (c["cljsRatom"]);
if((G__13155_13157 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13155_13157);
}
...
var renders_13160 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_13161 = cljs.core.first(cljs.core.vals(renders_13160));
if((cljs.core.count(renders_13160) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_13160))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_13161)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_13161], 0)))].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(cljs.core.cst$sym$ifn_QMARK_,cljs.core.cst$sym$render_DASH_fun)], 0)))].join('')));
}
...
var name__$1 = (function (){var G__13159 = name;
switch (G__13159) {
case "":
...
var elem = (function (){var G__13170 = (function (){var or__6484__auto__ = (function (){var G__13172 = c;
if((G__13172 == null)){
return null;
} else {
return (G__13172["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6484__auto__)){
return or__6484__auto__;
...
return (G__13170["_currentElement"]);
}
})();
var name = (function (){var G__13173 = elem;
var G__13173__$1 = (((G__13173 == null))?null:(G__13173["type"]));
if((G__13173__$1 == null)){
return null;
} else {
return (G__13173__$1["displayName"]);
}
})();
var path = (function (){var G__13174 = elem;
var G__13174__$1 = (((G__13174 == null))?null:(G__13174["_owner"]));
var G__13174__$2 = (((G__13174__$1 == null))?null:reagent$impl$component$component_path(G__13174__$1));
if((G__13174__$2 == null)){
return null;
} else {
return [cljs.core.str(G__13174__$2),cljs.core.str(" > ")].join('');
}
})();
...
var G__13176 = c;
var G__13176__$1 = (((G__13176 == null))?null:G__13176.constructor);
if((G__13176__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__13176__$1);
}
}
})();
