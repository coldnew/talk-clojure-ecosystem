...
var G__13135 = o;
(G__13135[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__13143 = jsprops;
(G__13143["defaultValue"] = value);

(G__13143["onChange"] = ((function (G__13143,v,value,on_change){
return (function (p1__13141_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13141_SHARP_);
});})(G__13143,v,value,on_change))
);
...
var vec__13148 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13148,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13148,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13148,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___13151 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13151 == null)){
} else {
var key_13152 = temp__4661__auto___13151;
(jsprops["key"] = key_13152);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13154 = (new reagent.impl.template.NativeWrapper());
(G__13154["name"] = c);
...
var G__13156 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13156) : reagent.impl.template.as_element.call(null,G__13156));
} else {
...
var len__7542__auto___13162 = arguments.length;
var i__7543__auto___13163 = (0);
while(true){
if((i__7543__auto___13163 < len__7542__auto___13162)){
args__7549__auto__.push((arguments[i__7543__auto___13163]));

var G__13164 = (i__7543__auto___13163 + (1));
i__7543__auto___13163 = G__13164;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13160){
var G__13161 = cljs.core.first(seq13160);
var seq13160__$1 = cljs.core.next(seq13160);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13161,seq13160__$1);
});
...
break;
default:
var G__13168 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13168;
continue;
...
var n__7387__auto___13169 = a.length;
var i_13170 = (0);
while(true){
if((i_13170 < n__7387__auto___13169)){
(a[i_13170] = reagent.impl.template.as_element((a[i_13170])));

var G__13171 = (i_13170 + (1));
i_13170 = G__13171;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7387__auto___13172 = a.length;
var i_13173 = (0);
while(true){
if((i_13173 < n__7387__auto___13172)){
var val_13174 = (a[i_13173]);
if((cljs.core.vector_QMARK_(val_13174)) && ((reagent.impl.template.key_from_vec(val_13174) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13173] = reagent.impl.template.as_element(val_13174));

var G__13175 = (i_13173 + (1));
i_13173 = G__13175;
continue;
} else {
}
...
var ctx = {};
var vec__13177 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13177,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13177,(1),null);
...
var G__13179 = (cljs.core.count(argv) - first_child);
switch (G__13179) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13179){
