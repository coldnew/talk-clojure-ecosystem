...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([initial_state,p1__14610_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_14611 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_14612 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_14611);
var pos_14613 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_14611);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_14612);

var tr__14534__auto___14614 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_14612) - cljs.core.first(pos_14613)),(((quil.core.height() / (2)) / zoom_14612) - cljs.core.second(pos_14613))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__14534__auto___14614);
...
var G__14619 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__14620 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__14619,G__14620) : user_mouse_dragged.call(null,G__14619,G__14620));
...
return (function (state,event){
var G__14621 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__14622 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__14621,G__14622) : user_mouse_wheel.call(null,G__14621,G__14622));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
