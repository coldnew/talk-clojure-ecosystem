...
return (function quil$middlewares$deprecated_options$deprecated_options_$_iter__13465(s__13466){
return (new cljs.core.LazySeq(null,((function (options__$1){
return (function (){
var s__13466__$1 = s__13466;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__13466__$1);
if(temp__4657__auto__){
var s__13466__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__13466__$2)){
var c__7254__auto__ = cljs.core.chunk_first(s__13466__$2);
var size__7255__auto__ = cljs.core.count(c__7254__auto__);
var b__13468 = cljs.core.chunk_buffer(size__7255__auto__);
if((function (){var i__13467 = (0);
while(true){
if((i__13467 < size__7255__auto__)){
var vec__13475 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__7254__auto__,i__13467);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13475,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13475,(1),null);
cljs.core.chunk_append(b__13468,(function (){var temp__4655__auto__ = (quil.middlewares.deprecated_options.deprecated.cljs$core$IFn$_invoke$arity$1 ? quil.middlewares.deprecated_options.deprecated.cljs$core$IFn$_invoke$arity$1(name) : quil.middlewares.deprecated_options.deprecated.call(null,name));
if(cljs.core.truth_(temp__4655__auto__)){
var vec__13476 = temp__4655__auto__;
var version = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13476,(0),null);
var message = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13476,(1),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13468),quil$middlewares$deprecated_options$deprecated_options_$_iter__13465(cljs.core.chunk_rest(s__13466__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13468),null);
}
} else {
var vec__13477 = cljs.core.first(s__13466__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13477,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13477,(1),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__13478 = temp__4655__auto__;
var version = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13478,(0),null);
var message = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13478,(1),null);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([name,"option was removed in Quil",version,".",message], 0));
...
})(),quil$middlewares$deprecated_options$deprecated_options_$_iter__13465(cljs.core.rest(s__13466__$2)));
}
} else {
return null;
}
