...
var vec__14102 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14102,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14102,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14102,(2),null);
var vec__14103 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14103,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14103,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14103,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__14104,p__14105){
var vec__14108 = p__14104;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14108,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14108,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14108,(2),null);
var vec__14109 = p__14105;
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14109,(0),null);
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14109,(1),null);
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14109,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__14110_SHARP_){
return (p1__14110_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__14111_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__14112_SHARP_,angle_lr),angle_ud);
...
var map__14119 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14119__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14119__$1,cljs.core.cst$kw$straight);
var temp__4655__auto__ = (function (){var pred__14121 = cljs.core._EQ_;
var expr__14122 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((pred__14121.cljs$core$IFn$_invoke$arity$2 ? pred__14121.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$w,expr__14122) : pred__14121.call(null,cljs.core.cst$kw$w,expr__14122)))){
return straight;
} else {
if(cljs.core.truth_((pred__14121.cljs$core$IFn$_invoke$arity$2 ? pred__14121.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$s,expr__14122) : pred__14121.call(null,cljs.core.cst$kw$s,expr__14122)))){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__14121.cljs$core$IFn$_invoke$arity$2 ? pred__14121.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__14122) : pred__14121.call(null,quil.middlewares.navigation_3d.space,expr__14122)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((pred__14121.cljs$core$IFn$_invoke$arity$2 ? pred__14121.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$z,expr__14122) : pred__14121.call(null,cljs.core.cst$kw$z,expr__14122)))){
return up;
} else {
if(cljs.core.truth_((pred__14121.cljs$core$IFn$_invoke$arity$2 ? pred__14121.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$d,expr__14122) : pred__14121.call(null,cljs.core.cst$kw$d,expr__14122)))){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((pred__14121.cljs$core$IFn$_invoke$arity$2 ? pred__14121.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$a,expr__14122) : pred__14121.call(null,cljs.core.cst$kw$a,expr__14122)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),((function (dir,temp__4655__auto__,map__14119,map__14119__$1,up,straight){
return (function (p1__14113_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__14113_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
});})(dir,temp__4655__auto__,map__14119,map__14119__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([initial_state,p1__14124_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var rotate_on_fn = (function (){var G__14136 = options;
var G__14137 = ((function (G__14136,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed){
return (function (state,_){
return state;
});})(G__14136,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed))
;
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__14136,G__14137) : rotate_on.call(null,G__14136,G__14137));
})();
...
var map__14138_14147 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__14138_14148__$1 = ((((!((map__14138_14147 == null)))?((((map__14138_14147.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14138_14147.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14138_14147):map__14138_14147);
var vec__14139_14149 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14138_14148__$1,cljs.core.cst$kw$straight);
var c_x_14150 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14139_14149,(0),null);
var c_y_14151 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14139_14149,(1),null);
var c_z_14152 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14139_14149,(2),null);
var vec__14140_14153 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14138_14148__$1,cljs.core.cst$kw$up);
var u_x_14154 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14140_14153,(0),null);
var u_y_14155 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14140_14153,(1),null);
var u_z_14156 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14140_14153,(2),null);
var vec__14141_14157 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14138_14148__$1,cljs.core.cst$kw$position);
var p_x_14158 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14141_14157,(0),null);
var p_y_14159 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14141_14157,(1),null);
var p_z_14160 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14141_14157,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_14158,p_y_14159,p_z_14160,(p_x_14158 + c_x_14150),(p_y_14159 + c_y_14151),(p_z_14160 + c_z_14152),u_x_14154,u_y_14155,u_z_14156);
...
var G__14143 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__14144 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__14143,G__14144) : key_pressed.call(null,G__14143,G__14144));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
,rotate_on,((function (user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup){
return (function (state,event){
var G__14145 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__14146 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__14145,G__14146) : rotate_on_fn.call(null,G__14145,G__14146));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
], 0));
});
