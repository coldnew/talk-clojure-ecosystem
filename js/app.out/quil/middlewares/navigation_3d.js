...
var vec__14233 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14233,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14233,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14233,(2),null);
var vec__14234 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14234,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14234,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14234,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__14235,p__14236){
var vec__14239 = p__14235;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14239,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14239,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14239,(2),null);
var vec__14240 = p__14236;
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14240,(0),null);
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14240,(1),null);
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14240,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__14241_SHARP_){
return (p1__14241_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__14242_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__14243_SHARP_,angle_lr),angle_ud);
...
var map__14250 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__14250__$1 = ((((!((map__14250 == null)))?((((map__14250.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14250.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14250):map__14250);
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14250__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14250__$1,cljs.core.cst$kw$straight);
var temp__4655__auto__ = (function (){var pred__14252 = cljs.core._EQ_;
var expr__14253 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((pred__14252.cljs$core$IFn$_invoke$arity$2 ? pred__14252.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$w,expr__14253) : pred__14252.call(null,cljs.core.cst$kw$w,expr__14253)))){
return straight;
} else {
if(cljs.core.truth_((pred__14252.cljs$core$IFn$_invoke$arity$2 ? pred__14252.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$s,expr__14253) : pred__14252.call(null,cljs.core.cst$kw$s,expr__14253)))){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__14252.cljs$core$IFn$_invoke$arity$2 ? pred__14252.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__14253) : pred__14252.call(null,quil.middlewares.navigation_3d.space,expr__14253)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((pred__14252.cljs$core$IFn$_invoke$arity$2 ? pred__14252.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$z,expr__14253) : pred__14252.call(null,cljs.core.cst$kw$z,expr__14253)))){
return up;
} else {
if(cljs.core.truth_((pred__14252.cljs$core$IFn$_invoke$arity$2 ? pred__14252.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$d,expr__14253) : pred__14252.call(null,cljs.core.cst$kw$d,expr__14253)))){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((pred__14252.cljs$core$IFn$_invoke$arity$2 ? pred__14252.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$a,expr__14253) : pred__14252.call(null,cljs.core.cst$kw$a,expr__14253)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),((function (dir,temp__4655__auto__,map__14250,map__14250__$1,up,straight){
return (function (p1__14244_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__14244_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
});})(dir,temp__4655__auto__,map__14250,map__14250__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([initial_state,p1__14255_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var rotate_on_fn = (function (){var G__14267 = options;
var G__14268 = ((function (G__14267,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed){
return (function (state,_){
return state;
});})(G__14267,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed))
;
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__14267,G__14268) : rotate_on.call(null,G__14267,G__14268));
})();
...
var map__14269_14278 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__14269_14279__$1 = ((((!((map__14269_14278 == null)))?((((map__14269_14278.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14269_14278.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14269_14278):map__14269_14278);
var vec__14270_14280 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14269_14279__$1,cljs.core.cst$kw$straight);
var c_x_14281 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14270_14280,(0),null);
var c_y_14282 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14270_14280,(1),null);
var c_z_14283 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14270_14280,(2),null);
var vec__14271_14284 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14269_14279__$1,cljs.core.cst$kw$up);
var u_x_14285 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14271_14284,(0),null);
var u_y_14286 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14271_14284,(1),null);
var u_z_14287 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14271_14284,(2),null);
var vec__14272_14288 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14269_14279__$1,cljs.core.cst$kw$position);
var p_x_14289 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14272_14288,(0),null);
var p_y_14290 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14272_14288,(1),null);
var p_z_14291 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14272_14288,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_14289,p_y_14290,p_z_14291,(p_x_14289 + c_x_14281),(p_y_14290 + c_y_14282),(p_z_14291 + c_z_14283),u_x_14285,u_y_14286,u_z_14287);
...
var G__14274 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__14275 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__14274,G__14275) : key_pressed.call(null,G__14274,G__14275));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
,rotate_on,((function (user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup){
return (function (state,event){
var G__14276 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__14277 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__14276,G__14277) : rotate_on_fn.call(null,G__14276,G__14277));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
], 0));
});
