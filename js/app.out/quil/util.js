...
var or__6484__auto__ = cljs.core.last(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13482_SHARP_){
return p1__13482_SHARP_.length();
}),cljs.core.keys(m))));
...
var args13483 = [];
var len__7542__auto___13486 = arguments.length;
var i__7543__auto___13487 = (0);
while(true){
if((i__7543__auto___13487 < len__7542__auto___13486)){
args13483.push((arguments[i__7543__auto___13487]));

var G__13488 = (i__7543__auto___13487 + (1));
i__7543__auto___13487 = G__13488;
continue;
} else {
}
break;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13494_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__13494_SHARP_,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([cljs.core.str("PConstants/"),cljs.core.str(quil.util.prepare_quil_name(p1__13494_SHARP_))].join(''))],null));
}),constants));
});
quil.util.prepare_quil_cljs_constants = (function quil$util$prepare_quil_cljs_constants(constants){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13495_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__13495_SHARP_,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core._conj(cljs.core.List.EMPTY,cljs.core.cst$sym$cljs$core_SLASH_aget),cljs.core._conj(cljs.core.List.EMPTY,cljs.core.cst$sym$js_SLASH_Processing$prototype$PConstants),cljs.core.array_seq([cljs.core._conj(cljs.core.List.EMPTY,quil.util.prepare_quil_name(p1__13495_SHARP_))], 0))))],null));
}),constants));
});
...
var len__7542__auto___13501 = arguments.length;
var i__7543__auto___13502 = (0);
while(true){
if((i__7543__auto___13502 < len__7542__auto___13501)){
args__7549__auto__.push((arguments[i__7543__auto___13502]));

var G__13503 = (i__7543__auto___13502 + (1));
i__7543__auto___13502 = G__13503;
continue;
} else {
}
break;
...
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core._conj(cljs.core.List.EMPTY,cljs.core.cst$sym$do),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13496_SHARP_){
return quil.util.make_quil_constant_map(target,cljs.core.first(p1__13496_SHARP_),cljs.core.second(p1__13496_SHARP_));
}),cljs.core.partition.cljs$core$IFn$_invoke$arity$2((2),opts)))));
});

quil.util.generate_quil_constants.cljs$lang$maxFixedArity = (3);

quil.util.generate_quil_constants.cljs$lang$applyTo = (function (seq13497){
var G__13498 = cljs.core.first(seq13497);
var seq13497__$1 = cljs.core.next(seq13497);
var G__13499 = cljs.core.first(seq13497__$1);
var seq13497__$2 = cljs.core.next(seq13497__$1);
var G__13500 = cljs.core.first(seq13497__$2);
var seq13497__$3 = cljs.core.next(seq13497__$2);
return quil.util.generate_quil_constants.cljs$core$IFn$_invoke$arity$variadic(G__13498,G__13499,G__13500,seq13497__$3);
});
