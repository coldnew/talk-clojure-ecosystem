...
if((i__$1 > (0))){
var G__12142 = s__$1.replace(hipo.hiccup.class_separator," ");
s__$1 = G__12142;
continue;
} else {
return s__$1;
...
while(true){
if(cljs.core.seq(s)){
var G__12144 = (function (){var f = cljs.core.first(s);
...
var G__12146 = ((cljs.core.seq_QMARK_(f))?hipo.hiccup.conjs_BANG_(acc,f):((!((f == null)))?cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,f):acc
));
var G__12147 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(v__$1,(1));
acc = G__12146;
v__$1 = G__12147;
continue;
}
